...
bool dataset::parse_experiment_var(std::istringstream& iss)
{
...
bool dataset::parse_scale_var(std::istringstream& iss)
{
  std::string secondary_variable;
  iss >> secondary_variable;
...
bool dataset::parse_boundary_var(std::istringstream& iss)
{
  std::string secondary_variable;
  iss >> secondary_variable;
  if(secondary_variable == "x")
...
bool dataset::parse_magnification_var(std::istringstream& iss)
{
  iss >> magnification;
  return iss.good();
}
